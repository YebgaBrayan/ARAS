<?php
    ...
    ?>
<html lang="en" data-theme="light" class=""><!-- Mirrored from social.webestica.com/my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 May 2022 10:36:03 GMT --><head>
	<title>ARAS-Soutien</title>
...
<body class="" style="display:inline;">
  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-8 vstack gap-4">
        ...
        <div class="card">
          <!-- Cover image -->
          <div class="h-200px rounded-top" style="background-image:url({{ asset('storage') . '/' . Auth::user()->path }}); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
            <!-- Card body START -->
            <div class="card-body py-0">
              <div class="d-sm-flex align-items-start text-center text-sm-start">
                <div>
                  ...
                  <div class="avatar avatar-xxl mt-n5 mb-3">
                    <img class="avatar-img rounded-circle border border-white border-3" src="{{ asset('storage') . '/' . Auth::user()->path }}" alt="MTN">
                  </div>
                </div>
              ...
              <ul class="list-inline mb-0 text-center text-sm-start mt-3 mt-sm-0">
                ...
                <li class="list-inline-item"><i class="bi bi-calendar2-plus me-1"></i> Joined on <time datetime="{{ explode(' ', Auth::user()->created_at)[0]}}">{{ date_format(date_create(Auth::user()->created_at),'d F, 20y') }}
              </time></li>
              </ul>
            </div>
            <!-- Card body END -->
            <div class="card-footer mt-3 pt-2 pb-0">
              ...
              <ul class="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
                <li class="nav-item"> <a class="nav-link active" href="/redirects"> Posts </a> </li>
                ...
                <li class="nav-item"> <a class="nav-link" href="/Soutien-Video"> Videos</a> </li>
          ...
          <div class="d-flex mb-3">
            ...
            <div class="avatar avatar-xs me-2">
              <a href="#"> <img class="avatar-img rounded-circle" src="{{ asset('storage') . '/' . Auth::user()->path }}" alt=""> </a>
            </div>

            <!-- Post input -->

            <form class="w-100"  action="{{ route("soutien.pub2") }}" method="post">
                @csrf
               <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id}}">
              <textarea class="form-control pe-4 border-0" rows="2" data-autoresize="" name="libellé" id="libellé" placeholder="Share your thoughts..."></textarea>


          </div><button type="submit" class="btn btn-success-soft" style="width: 80%;margin-bottom:1cm;padding-left:30px;">Post</button>
        </form>
          ...
          <div class="card">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar avatar-story me-2">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="{{ asset('storage') . '/' . User::find($yeb->user_id)->path }}" alt=""> </a>
                  </div>
                  <!-- Info -->
                  <div>
                    <div class="nav nav-divider">
                      <h6 class="nav-item card-title mb-0"> <a href="#!"> {{ User::find($yeb->user_id)->name}} </a></h6>
                      <span class="nav-item small"><time datetime="{{ explode(' ', $yeb->created_at)[0]}}">{{ date_format(date_create($yeb->created_at),'d F, 20y') }}
                      </time></span>

                    </div>
                    <p class="mb-0 small">{{ User::find($yeb->user_id)->email}}</p>
                  </div>
                </div>
            ...
            <div class="card-body">
              <p>{{$yeb->libellé}}</p>
              <!-- Card img -->
              <img width="320" height="240" class="card-img" src="{{ asset('storage') . '/' . $yeb->path }}" alt="Post">
              <!-- Feed react START -->
              <ul class="nav nav-stack py-3 small">
                <li class="nav-item">
                  <a class="nav-link active" href="#!"> <i class="bi bi-hand-thumbs-up-fill pe-1"></i>Liked (0)</a>
                </li>
                <li class="nav-item">
                    <?php
                    $count1 = comment::all()->where('soutienpost_id',$yeb->id)->count();
                    $count2 = repondre::all()->where('soutienpost_id',$yeb->id)->count();
                    $count =$count1 + $count2;
                    ?>
                  <a class="nav-link" href="#!"> <i class="bi bi-chat-fill pe-1"></i>Comments ({{ $count }})</a>
                </li>
              ...
              <div class="d-flex mb-3">
                ...
                <!-- Comment box  -->
                @if ($message = Session::get('comment1'))
                <div class=".alert alert-success">
                    <P>{{$message }}</P>
                </div>
                @endif
                <form method="POST" class="position-relative w-100" action="{{ route('comments.store') }}">
                    @csrf
                    <input type="hidden" name="soutienpost_id" id="soutienpost_id" value="{{$yeb->id}}">
                    <input type="hidden" name="cat" id="cat" value="1">

                  <textarea class="form-control pe-4 bg-light @error('content') is-invalid @enderror"

                   name="content" id="content" rows="1" placeholder="Add a comment..." required></textarea>
                  @error('content')
                      <div class="invalid-feedback">{{ $errors->first('content') }}</div>
                  @enderror
                  <button type="submit" class="btn btn-primary" style="margin-top: 0.2cm;">Envoyer<i class="far fa-2x fa-paper-plane"></i></button>
                </form>
              </div>
              <!-- Comment wrap START -->
              <?php
                $comment=comment::all()->where('soutienpost_id',$yeb->id);
              ?>
                    ...
                    <div class="ms-2">
                      ...
                      <div class="bg-light rounded-start-top-0 p-3 rounded">
                        <div class="d-flex justify-content-between">
                            <?php
                            $Author = User::all()->where('id', $comments->user_id);
                            ?>
                          <h6 class="mb-1"> <a href="#!"> {{ User::find($yeb->user_id)->name }}</a></h6>
                        <small class="ms-2">Posté le: <time datetime="{{ explode(' ', $comments->created_at)[0]}}">{{ date_format(date_create($comments->created_at),'d F, 20y') }}
                          </time></small>
                          {{-- <small class="ms-2">Posté le {{ $comments->created_at->format('d/m/y') }} </small> --}}
                        </div>
                        <p class="small mb-0">{{ $comments->content }}</p>
                      </div>
                      <?php
                      $repondre = DB::table('repondres')->where('comment_id', '=', $comments->id)->get();
                      ?>
                      @foreach ($repondre as $Repondres )

              <ul class="comment-wrap list-unstyled mt-2 ml-5 ">
                <!-- Comment item START -->
                <li class="comment-item ">
                  <div class="d-flex position-relative">
                    <!-- Avatar -->
                    ...
                    <div class="ms-2">
                      ...
                      <div class="bg-light rounded-start-top-0 p-3 rounded">
                        <div class="d-flex justify-content-between">
                            <?php
                            $Author = User::all()->where('id', $Repondres->user_id);
                            ?>
                          <h6 class="mb-1"> <a href="#!"> @foreach ($Author as $item)
                            {{ $item->name }}
                        @endforeach </a></h6>
                          <small class="ms-2">Posté le: <time datetime="{{ explode(' ', $Repondres->created_at)[0]}}">{{ date_format(date_create($Repondres->created_at),'d F, 20y') }}
                          </time></small>
                        </div>
                        <p class="small mb-0">{{ $Repondres->content }}</p>
                      </div>
            ...
            @endforeach
            <ul><li class="nav-item" style="margin-top: -7px;" onclick="toggleReplyComment({{ $comments->id }})">
                <a class="nav-link" href="#!"> Répondre</a>
              </li></ul>

                      <div class="d-flex mb-3"style="width:100%" >
                        @if ($message = Session::get('reponse1'))
                        <div class=".alert alert-success">
                            <P>{{$message }}</P>
                        </div>
                        @endif
                      <form method="POST"style="width:100%" id="replyComment-{{ $comments->id }}" class="position-relative w-100 d-none" action="{{ route('reponse.store') }}">
                        @csrf
                        <input type="hidden" name="comment_id" id="comment_id" value="{{ $comments->id }}">
                        <label for="replyComment">Ma réponse</label>
                      <textarea style="width:100%" name="replyComment" id="replyComment" class="form-control pe-4 bg-light @error('replyComment') is-invalid @enderror"

                       rows="1" placeholder="Add a comment..." required></textarea>
                      @error('replyComment')
          ...
          <div class="card">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <div class="nav nav-divider">
                      ...
                      <small class="ms-2">Posté le: <time datetime="{{ explode(' ', $videos->created_at)[0]}}">{{ date_format(date_create($videos->created_at),'d F, 20y') }}
                      </time></small>
                    </div>
                      ...
                      <div class="bg-light rounded-start-top-0 p-3 rounded">
                        <div class="d-flex justify-content-between">
                          ...
                          <h6 class="mb-1"> <a href="#!"> @foreach ($Author as $item)
                            {{ $item->name }}
                        @endforeach </a></h6>
                          <small class="ms-2">Posté le {{ $Repondres->created_at}} </small>
                          <small class="ms-2">Posté le: <time datetime="{{ explode(' ', $Repondres->created_at)[0]}}">{{ date_format(date_create($Repondres->created_at),'d F, 20y') }}
                          </time></small>
                        </div>
                        <p class="small mb-0">{{ $Repondres->content }}</p>
            ...
            <ul><li class="nav-item" style="margin-top: -7px;" onclick="toggleReplyComment({{ $comments->id }})">
                <a class="nav-link" href="#!"> Répondre</a>
                      ...
                      <div class="d-flex mb-3"style="width:100%" >
                        @if ($message = Session::get('reponse2'))
                        <div class=".alert alert-success">
                            <P> {{$message }}</P>
            ...
            <div class="card-header border-0 pb-0">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <!-- Title -->
                  <div>
                    <h6 class="card-title mb-0"> <a href="#!"> {{ Auth::user()->name}} </a></h6>
                    <p class="mb-0 small">Posté le: <time datetime="{{ explode(' ', $yeb1->created_at)[0]}}">{{ date_format(date_create($yeb1->created_at),'d F, 20y') }}
                    </time></p>
                  </div>
                </div>
                <!-- Card share action menu -->
              ...
              <div class="card-body position-relative pt-0">
                ...
                <div class="d-flex">
                  ...
                  <div class="avatar me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="assets1/images/logo/08.svg" alt=""> </a>
                  </div>
                  <!-- Info -->
                  <div>
                ...
                <div class="d-flex">
                  <!-- Avatar -->
                  <div class="avatar me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="assets1/images/logo/09.svg" alt=""> </a>
                  </div>
                  <!-- Info -->
                  <div>
                ...
                <div class="d-flex">
                  <!-- Avatar -->
                  <div class="avatar me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="assets1/images/logo/10.svg" alt=""> </a>
                  </div>
                  <!-- Info -->
                  <div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class="d-flex mb-3">
          <!-- Avatar -->
          <div class="avatar avatar-xs me-2">
            <img class="avatar-img rounded-circle" src="{{ asset('storage') . '/' . Auth::user()->path }}" alt="">
          </div>
          <!-- Feed box  -->
          @if ($message = Session::get('comment2'))
          <div class=".alert alert-success">
              <P>{{$message }}</P>
          </div>
          @endif
        ...
        <div class="hstack gap-2">
          <a class="icon-md bg-success bg-opacity-10 text-success rounded-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Photo"> <i class="bi bi-image-fill"></i> </a>
          <a class="icon-md bg-info bg-opacity-10 text-info rounded-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Video"> <i class="bi bi-camera-reels-fill"></i> </a>
          <a class="icon-md bg-danger bg-opacity-10 text-danger rounded-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Events"> <i class="bi bi-calendar2-event-fill"></i> </a>
          <a class="icon-md bg-warning bg-opacity-10 text-warning rounded-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Feeling/Activity"> <i class="bi bi-emoji-smile-fill"></i> </a>
          <a class="icon-md bg-light text-secondary rounded-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Check in"> <i class="bi bi-geo-alt-fill"></i> </a>
          <a class="icon-md bg-primary bg-opacity-10 text-primary rounded-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tag people on top"> <i class="bi bi-tag-fill"></i> </a>
        </div>
        <!-- Feed rect END -->
      </div>
      <!-- Modal feed body END -->
      ...
      <div class="modal-footer row justify-content-between">
        <!-- Select -->
        <div class="col-lg-3">
          <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true" aria-expanded="false"><div class="choices__inner"><select class="form-select js-choice choices__input" data-position="top" data-search-enabled="false" hidden="" tabindex="-1" data-choice="active"><option value="PB">Public</option></select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="1" data-value="PB" data-custom-properties="null" aria-selected="true">Public</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><div class="choices__list" role="listbox"><div id="choices--2rb8-item-choice-1" class="choices__item choices__item--choice choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="PV" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Custom</div><div id="choices--2rb8-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="PV" data-select-text="Press to select" data-choice-selectable="">Friends</div><div id="choices--2rb8-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="PV" data-select-text="Press to select" data-choice-selectable="">Only me</div><div id="choices--2rb8-item-choice-4" class="choices__item choices__item--choice is-selected choices__item--selectable" role="option" data-choice="" data-id="4" data-value="PB" data-select-text="Press to select" data-choice-selectable="">Public</div></div></div></div>
        </div>
        <!-- Button -->
...
<div class="modal fade" id="feedActionPhoto" tabindex="-1" aria-labelledby="feedActionPhotoLabel" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <!-- Modal feed header START -->
      <div class="modal-header">
        <h5 class="modal-title" id="feedActionPhotoLabel">Ajouter un post photo</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <!-- Modal feed header END -->
        ...
        <div class="d-flex mb-3">
          ...
          @endif
          <form class="w-100" action="{{ route('soutien.pub') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id}}">

            <input type="text" class="form-control pe-4 fs-3 lh-1 border-0" rows="2" placeholder="Share your thoughts..." id="libellé" name="libellé">
        </div>
        ...
        <div>
          ...
          <div class="dropzone dropzone-default card shadow-none" data-dropzone="{&quot;maxFiles&quot;:2}">
            <div class="dz-message">
              ...
              @csrf
              <input type="file" name="contenu" id="contenu" placeholder="Drag here or click to upload photo." required>
            </div>
          </div>
        </div>
        <!-- Dropzone photo END -->
...
<div class="modal fade" id="feedActionVideo" tabindex="-1" aria-labelledby="feedActionVideoLabel" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
     <!-- Modal feed header START -->
     <div class="modal-header">
    ...
    <!-- Modal feed header END -->
      ...
      <div class="modal-body">
       ...
       <div class="d-flex mb-3">
        ...
        @endif
        <form class="w-100" action="{{ route('soutien.pubv') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id}}">

            <input type="text" name="libellé" id="libellé" class="form-control pe-4 fs-3 lh-1 border-0" rows="2" placeholder="Share your thoughts..." id="libellé" name="libellé">
        </div>
        ...
        <div>
          ...
          <div class="dropzone dropzone-default card shadow-none" data-dropzone="{&quot;maxFiles&quot;:2}">
            <div class="dz-message">
                ...
                @csrf
              <input type="file" name="contenu" id="contenu" placeholder="Drag here or click to upload photo.">
                <p>
        ...
        <div class="modal-footer ">
          <!-- Button -->@csrf
            <button type="button" class="btn btn-danger-soft me-2" data-bs-dismiss="modal">Live video</button>
            <button type="submit" class="btn btn-success-soft">Post</button>
        </form>
      </div>
      <!-- Modal feed footer -->
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endif
        <form class="row g-4" method="POST" enctype="multipart/form-data" action="{{ route('soutien.event') }}">
            @csrf
            <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id}}">
          ...
          <div class="col-12">
            ...
            <input type="text" class="form-control" name="title" id="title" placeholder="Event name here">
          </div>
          <!-- Description -->
          <div class="col-12">
            <label class="form-label">Description</label>
            <textarea class="form-control" rows="2" placeholder="" name="description" id="description"></textarea>
          </div>
          <!-- Date -->
          <div class="col-sm-4">
            <label class="form-label">Date</label>
            <input type="date" name="date" id="date" class="form-control flatpickr" placeholder="Select date">
          </div>
          <!-- Time -->
          <div class="col-sm-4">
            <label class="form-label">Time</label>
            <input type="time" class="form-control flatpickr" name="time" id="duration" data-enabletime="true" data-nocalendar="true" placeholder="Select time">
          </div>
          <!-- Duration -->
          <div class="col-sm-4">
            <label class="form-label">Duration</label>
            <input type="string" name="duration" id="duration" class="form-control" placeholder="10hr 31m">
          </div>
          <!-- Location -->
          <div class="col-12">
            <label class="form-label">Lieu (pays)</label>
            <input type="text" name="localisation" id="localisation" class="form-control" placeholder="Bepanda, IN 2 Etage">
          </div>
          <!-- Dropzone photo START -->
          <div>
            <label class="form-label">Upload attachment</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger-soft me-2" data-bs-dismiss="modal"> Cancel</button>
        <button type="submit" class="btn btn-success-soft">Create now</button>        </form>
        ...
        <div class="col-sm-6 col-lg-3">
          ...
          <div class="card h-100">
            <div class="position-relative">
              <img class="img-fluid rounded-top" src="{{ asset('storage') . '/' . Auth::user()->path }}" alt="">
            </div>
            <!-- Card body START -->
            <div class="card-body position-relative pt-0">
              <!-- Tag -->
              <a class="btn btn-xs btn-primary mt-n3" href="event-details-2.html">{{ $events->title }} </a>
              <h5 class="mt-3"> <a href="event-details-2.html">{{ $events->description }} </a> </h5>
              <!-- Date time -->
              <p class="mb-0 small"> <i class="bi bi-calendar-check pe-1"></i> {{ $events->date }} à {{ $events->time }} pendant {{ $events->duration }} </p>
              <p class="small"> <i class="bi bi-geo-alt pe-1"></i> {{ $events->localisation }} </p>
              <!-- Avatar group START -->
              <?php
              ...
              <ul class="avatar-group list-unstyled align-items-center mb-0">
                <li class="avatar avatar-xs">
                  <div class="avatar-img rounded-circle bg-primary"><span class="smaller text-white position-absolute top-50 start-50 translate-middle">+@foreach ($orders as $item)
              ...
              <img width="320" height="240" class="card-img" src="{{ asset('storage') . '/' . $events->path }}" alt="Post">
...
<a href="#!" role="button" class="btn btn-loader btn-primary-soft" data-bs-toggle="button" aria-pressed="true" style="width: 100ù=%">
  ...
  <div class="alert alert-light fade show position-fixed start-0 bottom-0 z-index-99 shadow p-4 m-3 col-10 col-md-4 col-lg-3" role="alert">
	<div class="text-dark">
    <!-- Image -->
    <img src="assets1/images/cookie.svg" class="h-50px mb-3" alt="cookie">
    <!-- Content -->
...
<!-- Vendors -->
<script src="assets1/vendor/dropzone/dist/dropzone.js"></script>
<script src="assets1/vendor/choices.js/public/assets/scripts/choices.min.js"></script>
<script src="assets1/vendor/glightbox-master/dist/js/glightbox.min.js"></script>
<script src="assets1/vendor/flatpickr/dist/flatpickr.min.js"></script>
...
<!-- Mirrored from social.webestica.com/my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 May 2022 10:36:07 GMT -->
</body></html>
