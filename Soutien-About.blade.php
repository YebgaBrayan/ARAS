...
<html lang="en"><!-- Mirrored from social.webestica.com/my-profile-about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 May 2022 10:36:07 GMT --><head>
	<title>Aras-Soutien-About</title>
          ...
          <div class="h-200px rounded-top" style="background-image:url(assets1/images/avatar/07.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
            ...
            <div class="card-footer mt-3 pt-2 pb-0">
              ...
              <ul class="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
                ...
                <li class="nav-item"> <a class="nav-link active" href="/Soutien-About"> About </a> </li>
              ...
              <div class="row g-4">
                <div class="col-sm-6">
                  ...
                  <div class="d-flex align-items-center rounded border px-3 py-2">
                    <!-- Date -->
                    <p class="mb-0">
                      <i class="bi bi-calendar-date fa-fw me-2"></i> Born: <strong> {{ Auth::user()->created_at}} </strong>
                    </p>
                    <div class="dropdown ms-auto">
                      <!-- Card share action menu -->
                ...
                <div class="col-sm-6">
                  ...
                  <div class="d-flex align-items-center rounded border px-3 py-2">
                    <!-- Date -->
                    <p class="mb-0">
                      <i class="bi bi-geo-alt fa-fw me-2"></i> Lives in: <strong>{{ Auth::user()->Place_of_birth}} </strong>
                    </p>
                    <div class="dropdown ms-auto">
                      <!-- Card share action menu -->
