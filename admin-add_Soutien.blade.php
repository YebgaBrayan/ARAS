                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="d-flex justify-content-center py-4">
                    <a href="index.html" class="logo d-flex align-items-center w-auto">
                      ...
                      <span class="d-none d-lg-block"><i class="fas fa-arrow-left"></i>Admin-Create-New-User</span>
                    </a>
                  </div><!-- End Logo -->
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      @endif
                      <form class="row g-3 needs-validation"  method="POST" action="{{ route('admin.logins') }}">
                        @csrf
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label for="name" class="form-label">Votre prenom</label>
                        ...
                        <div class="col-12">
                          ...
                          <input type="number" name="number" class="form-control" id="number" :value="old('number')" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="localisation_adresse" :value="old('localisation_adresse')" class="form-control" autocomplete="current-password" id="password" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="password" name="password_confirmation" :value="old('password_confirmation')" class="form-control" autocomplete="current-password" id="password_confirmation" required>
                            <div class="invalid-feedback">Please enter your password!</div>
                          </div>
                        <div class="col-12">
                            <label for="Role" class="form-label">Role</label>
                            <input type="number" name="Role" :value="old('Role')" class="form-control" min="0"  max="2" id="Role" required>
                            <div class="invalid-feedback">Please enter your password!</div>
                          </div>
                          {{-- <div class="col-12">
                            <label for="Sexe" class="form-label">Sexe</label>
                            <input type="text" name="Role" :value="old('Sexe')" class="form-control"  id="Sexe" required>
                            <div class="invalid-feedback">Sexe</div>
                          </div>
                          <div class="col-12">
                            <label for="Age" class="form-label">Age</label>
                            <input type="number" name="Role" :value="old('Age')" class="form-control"  id="Age" required>
                            <div class="invalid-feedback">Sexe</div>
                          </div>
                          <div class="col-12">
                            <label for="birthday" class="form-label">birthday</label>
                            <input type="date" name="Role" :value="old('birthday')" class="form-control"  id="birthday" required>
