<?php
    ...
    $posts = Soutienpost::all();
            $posts1 = Soutienpostsimple::all();
...
<!-- Mirrored from social.webestica.com/my-profile-media.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 May 2022 10:36:08 GMT -->
<head>
	<title>Aras-Soutien-Media</title>
              ...
              <div class="h-200px rounded-top" style="background-image:url(assets1/images/avatar/07.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
                ...
                <div class="card-footer mt-3 pt-2 pb-0">
                  ...
                  <ul class="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
                    ...
                    <li class="nav-item"> <a class="nav-link active" href="/Soutien-Media"> Photos</a> </li>
                 ...
                 <div class="d-flex align-items-center">
                   ...
                   <div>
                     <div class="nav nav-divider">
                       ...
                       <span class="nav-item small">{{ $yeb->created_at}}</span>
                     </div>
