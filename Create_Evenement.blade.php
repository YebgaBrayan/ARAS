...
<!-- **************** MAIN CONTENT START **************** -->
<main>
    <a href="/redirects"><button type="button" class="btn btn-success-soft" style="width: 12%;margin-bottom:-2cm;padding-left:30px;">Back</button></a>
  <!-- Container START -->
  <div class="container">
    <div class="row g-4">
          ...
          <div class="d-flex mb-3">
            ...
            <div class="avatar avatar-xs me-2">
              <a href="#"> <img class="avatar-img rounded-circle" src="assets1/images/avatar/03.jpg" alt=""> </a>
            </div>
          ...
          </div><button type="submit" class="btn btn-success-soft" style="width: 30%;margin-bottom:1cm;margin-left:45%;">Post</button>
        </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class="d-flex mb-3">
          <!-- Avatar -->
          <div class="avatar avatar-xs me-2">
            <img class="avatar-img rounded-circle" src="assets1/images/avatar/03.jpg" alt="">
          </div>
          <!-- Feed box  -->
          @if ($message = Session::get('success'))
          <div class=".alert alert-success">
