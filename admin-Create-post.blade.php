        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                            <span class="nav-main-link-name">Gestion des événements</span>
                                        </a>
                                        <ul class="nav-main-submenu">
                                            <li class="nav-main-item">
            ...
            <main id="main-container">
                ...
                <div class="bg-body-light">
                    <div class="content content-full">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Post</h1>
                ...
                <div class="content content-full content-boxed">
                    ...
                    <form action="{{ route('soutien.pub') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                                ...
                                <div class="row justify-content-center push">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dm-post-add-title" name="libellé" placeholder="Enter a title.." required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Body</label>
                                            <textarea id="js-ckeditor" name="contenu" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        ...
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="https://1.envato.market/r6y" target="_blank">YMB-Production</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
...
<script>
const submitBtn = document.querySelector(".btn btn-alt-primary");
