              ...
              <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body p-0">
                  ...
                  <div class="card w-100">
                    ...
                    <!-- Side Nav START -->
                    <ul class="nav nav-tabs nav-pills nav-pills-soft flex-column fw-bold gap-2 border-0" style="text-align: center">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="/Soutien-settings"> Setting </a> </li>
                ...
                <p class="small text-center mt-1">©2022 <a class="text-body" target="_blank" href="mailto:yebgabrayan@gmail.com"> Aras 1.0 </a></p>
                ...
                <div class="tab-pane show active fade" id="nav-setting-tab-1">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-header border-0 pb-0">
                      ...
                      <p class="mb-0">Il vous est possile de modifier vos informations. Pour plus de détail contactez l'adminisrateur.</p>
                    </div>
                    <!-- Card header START -->
                    <!-- Card body START -->
                    <div class="card-body">
                      ...
                      @endif
                      <form class="row g-3" method="POST" enctype="multipart/form-data" action="{{ url('edit/'.Auth::user()->id) }}">
                        @csrf
                        <!-- First name -->
                        ...
                        <div class="col-sm-6 col-lg-4">
                          ...
                          <input type="text"name="surname" class="form-control" placeholder="" value="{{ Auth::user()->surname}}">
                        </div>
                        <!-- Additional name -->
                        <div class="col-sm-6 col-lg-4">
                          <label for="Place_of_birth"class="form-label">Place_of_birth</label>
                          <input type="text"  name="Place_of_birth" class="form-control" placeholder="" value="{{ Auth::user()->Place_of_birth}}">
                        </div>
                        <!-- User name -->
                        <div class="col-sm-6">
                          <label for="Status" class="form-label">Status</label>
                          <input type="text" name="Status" class="form-control" placeholder="" value="Soutien-Partenaire">
                        </div>
                        <!-- Birthday -->
                        <div class="col-lg-6">
                        ...
                        <div class="col-12">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="allowChecked">
                              Accepter encore une fois les régles
                            </label>
                          </div>
                        </div>
                        <!-- Phone number -->
                        <div class="col-sm-6">
                          ...
                          <input type="number" name="number" class="form-control" placeholder="" value="{{ Auth::user()->number}}">
                          <!-- Add new number -->
                        </div>
                        <!-- Phone number -->
                        <div class="col-sm-6">
                          <label for="email"class="form-label">Email</label>
                          <input type="email" name="email"class="form-control" placeholder="" value="{{ Auth::user()->email}}">
                          <!-- Add new email -->
                        </div>
                        <div class="col-sm-6">
                          <label for="avatar"class="form-label">Photo</label>
                          <input type="file" name="avatar"class="form-control" placeholder="" value="{{ Auth::user()->email}}">
                          <!-- Add new email -->
                        </div>
                        <div class="col-lg-6">
                            <label for="localisation_adresse" class="form-label"> Adresse de Localisation </label>
                            <input type="text" name="localisation_adresse" class="form-control" value="{{ Auth::user()->localisation_adresse}}">
