              ...
              <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    <figure class="m-0 position-absolute top-50 start-50 translate-middle w-100 h-100 opacity-1 overflow-hidden">
                      ...
                      <div class="card mb-3">
                        ...
                        <div class="card-body">
                          ...
                          <div class="pt-4 pb-2">
                            <h5 class="card-title text-center pb-0 fs-4">ARAS-Update-Account</h5>
                            <p class="text-center small" style="color: red;font-weight:bold; ">Si cela n'est pas fait, remplissé la totalité des informations</p>
                          </div>

                          <form class="row g-3 needs-validation" enctype="multipart/form-data" method="POST" action="{{ url('edit/'.Auth::user()->id) }}">
                            @csrf
                            <input type="hidden" name="user_id" value="{{Auth::user()->id}}" >

                            <div class="col-12">
                              <label for="number" class="form-label">Number</label>
                              <input type="number" name="number" class="form-control" id="number" value="{{ Auth::user()->number}}" required>
                            ...
                            <div class="col-12">
                                <label for="localisation_adresse" class="form-label">Localisation_adresse</label>
                                <input type="text" name="localisation_adresse" value="{{ Auth::user()->localisation_adresse}}" class="form-control" autocomplete="current-password" id="password" required>
                                <div class="invalid-feedback">Localisation_adresse!</div>
                              </div>

                            <div class="col-12">
                              <label for="Sexe" class="form-label">Sexe</label>
                              <input type="text" name="Sexe" class="form-control" value="{{ Auth::user()->sexe}}" id="Sexe" required>
                              <div class="invalid-feedback">Please enter your sexe!</div>
                            </div>
                            <div class="col-12">
                              <label for="Age" class="form-label">Age</label>
                              <input type="text" name="Age" class="form-control" value="{{ Auth::user()->Age}}" id="Age" required>
                              <div class="invalid-feedback">Please enter your age!</div>
                            </div>

                            <div class="col-12">
                              <label for="birthday" class="form-label">Birthday</label>
                              <input type="date"  name="birthday" class="form-control" value="{{ Auth::user()->birthday}}" id="birthday" required>
                              <div class="invalid-feedback">Please enter your birthday!</div>
                            </div>

                            <div class="col-12">
                              <label for="birthday" class="form-label">Lieu de naissance</label>
                              <input type="text"  name="Place_of_birth" class="form-control" value="{{ Auth::user()->Place_of_birth}}" id="Place_of_birth" required>
                              <div class="invalid-feedback">Please enter your Place_of_birth!</div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div class="invalid-feedback">Choisir une photo de profil</div>
                              </div>                              
                            <div class="col-12">
                                <button class="btn btn-primary w-100" type="submit"><i class="fa fa-fw fa-sign-in-alt mr-1"></i>Update</button>
                              </div>
                          </form>
                  ...
                  <div class="credits">
                    ...
                    Designed by <a href="mailto:yebgabrayan@gmail.com">YMB-Itech</a>
                  </div>
